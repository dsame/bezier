...
C:\msys64\mingw64\bin\gcc.exe -v -g  -static -shared -o bezier.dll "-Wl,--out-implib,bezier.lib" "-Wl,--major-image-version,2021,--minor-image-version,2" "-Wl,--whole-archive" CMakeFiles\bezier.dir/objects.a "-Wl,--no-whole-archive" @CMakeFiles\bezier.dir\linklibs.rsp -lquadmath -lgfortran -static-libquadmath
